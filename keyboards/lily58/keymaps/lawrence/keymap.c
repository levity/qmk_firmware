...
KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_D   , KC_V   , TG_QWER, KC_BSPC, KC_K   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, K_SH_BS, \
...
KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , TG_QWER, KC_BSPC, KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, K_SH_BS, \
                           KC_LALT, MO_FN  , KC_LGUI, KC_SPC , KC_ENT , MO_FN  , KC_RGUI, KC_RALT),
