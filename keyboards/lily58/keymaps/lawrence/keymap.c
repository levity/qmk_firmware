...
KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_D   , KC_V   , TG_COLM, KC_BSPC, KC_K   , KC_H   , KC_COMM, KC_DOT , KC_SLSH, K_SH_BS, \
                           KC_LALT, MO_FN  , KC_LGUI, KC_SPC , KC_ENT , MO_FN  , KC_RGUI, KC_RALT \
),

  [_FN] = LAYOUT(\
KC_GRV , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,                   KC_F6  , KC_F7  , KC_F8  , KC_LCBR, KC_RCBR, ___X___, \
_______, _______, _______, KC_LCBR, KC_RCBR, _______,                   ___X___, ___X___, KC_UP  , KC_LBRC, KC_RBRC, KC_BSLS, \
_______, _______, _______, KC_LPRN, KC_RPRN, _______,                   ___X___, KC_LEFT, KC_DOWN, KC_RGHT, ___X___, ___X___, \
_______, _______, _______, KC_LBRC, KC_RBRC, _______, _______, _______, TG_NUMP, TG_MOUS, K_LTAB , K_RTAB , ___X___, ___X___, \
